...
public class Init {
    ...
    public void init() {
        ...
        user1 = new User("admin", "$2a$10$h18Jn0dnwb7pAuAWtFIydec0rXVDQrh7LzLJwvfW2zbc.QKP/4Rd.", "admin@gmail.com");
        user2 = new User("user", "$2a$10$wTLs8HzcVUW3yOKCknkrE.oug5dKkui9Rl26ga6zYdB7zIQ5WdzFq", "user@gmail.com");
